...
// src/blockchain/protocols/aave/abi/poolAddressesProviderV3.abi.js
export const POOL_ADDRESSES_PROVIDER_V3_ABI = [
  {
    inputs: [],
    name: "getPool",
    outputs: [
...
// src/blockchain/protocols/aave/abi/aavePoolV3.abi.js
...
export const UI_POOL_DATA_PROVIDER_CHECK_ABI = [
  {
    inputs: [],
